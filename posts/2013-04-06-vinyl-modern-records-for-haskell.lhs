---
title: Vinyl: Modern Records for Haskell
---

<a href="http://github.com/jonsterling/Vinyl/">Vinyl</a> is a general solution to the
records problem in Haskell using type level strings and other modern GHC
features, featuring static structural typing (with a subtyping relation), and
automatic row-polymorphic lenses. All this is possible without Template Haskell.
